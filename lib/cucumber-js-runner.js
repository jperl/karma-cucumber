...
(function () {
    ...
    var my = {}, reporters = [], featureUrls = [], features = null, stepDefinitions = [], tags = [],
        featuresToLoad = 0;
    ...
    /**
     * Specify a filter tag to be used in the run configuration.
     * @param tag
     */
    Cucumber.filterByTag = function (tag) {
        tags.push(tag);
    };
    ...
    Cucumber.run = function (callback) {
        ...
        async.eachSeries(features, function (feature, featureRunCallback) {
            var cucumber = Cucumber(feature.text, stepDefinitionsSource, {tags: tags});
